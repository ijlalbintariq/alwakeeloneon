...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0f172a] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-all duration-200 ease-out" +
  " hover-elevate active-elevate-2 shadcn-button mac-anim",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-primary to-primary text-slate-950 border border-primary/70 shadow-[0_12px_24px_-14px_rgba(251,191,36,0.9)] hover:from-primary hover:to-primary",
        destructive:
