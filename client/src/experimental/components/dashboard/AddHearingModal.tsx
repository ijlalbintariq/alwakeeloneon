        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-lg bg-white border border-[#E5E4E2] text-[#2D2D2D] text-xs focus:outline-none focus:border-[#1A1A1A]"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              <label className="text-xs font-semibold text-[#4A4A4A] flex items-center gap-1">
                <CalendarDays className="w-3.5 h-3.5 text-[#1A1A1A]" />
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-white border border-[#E5E4E2] text-[#1A1A1A] text-xs focus:outline-none focus:border-[#1A1A1A]"
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                { key: "high", label: "High", color: "border-[#1A1A1A]/50 text-[#1A1A1A] bg-[#1A1A1A]/5" },
                { key: "normal", label: "Normal", color: "border-emerald-500/50 text-[#1A1A1A] bg-[#F5F4F2]" },
                { key: "low", label: "Low", color: "border-[#E5E4E2] text-[#4A4A4A] bg-[#F5F4F2]" },
              ].map((p) => (
                <button
                  type="button"
                  key={p.key}
                  ...
                  className={`py-1.5 rounded-lg text-xs font-medium border transition-all ${
                    priority === p.key
                      ...
                      : "border-[#E5E4E2] bg-white text-[#666666] hover:text-[#4A4A4A]"
                  }`}
                >
                  {p.label}
                </button>
