...
export const CalendarSyncPanel: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-5 rounded-2xl bg-white border border-[#E2E8F0] shadow-xs space-y-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {calStatus?.isConnected ? (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-mono font-bold bg-emerald-50 text-[#105B38] border border-emerald-200">
                  <Check className="w-3 h-3 stroke-[3]" />
                  <span>OAuth Connected</span>
                </span>
              ) : (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-mono font-semibold bg-[#F8FAFC] text-[#64748B] border border-[#E2E8F0]">
                  <span>Available</span>
                </span>
              )}
            </div>
          ...
          {calStatus?.isConnected ? (
            <>
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#F8FAFC] hover:bg-[#F1F5F9] text-[#0F172A] text-xs font-semibold border border-[#E2E8F0] transition-colors disabled:opacity-50"
              >
                <RefreshCw
              ...
              <button
                ...
                className="p-1.5 rounded-xl text-[#64748B] hover:text-rose-600 hover:bg-rose-50 transition-colors"
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-2 border-t border-[#E2E8F0] text-[11px]">
        <div className="p-2.5 rounded-xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-1">
          <div className="flex items-center gap-1.5 text-[#0F172A] font-semibold font-mono">
