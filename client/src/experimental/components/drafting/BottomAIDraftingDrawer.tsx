                    ...
                    >
                      ...
                      {msg.insertableClause && (
                        <div className="mt-3 pt-3 border-t border-[#E2E8F0] dark:border-[#1E2D44] space-y-2">
                          ...
                          <div className="p-3 rounded-lg bg-[#F8FAFC] dark:bg-[#0B131E] border border-[#E2E8F0] dark:border-[#1E2D44] font-serif text-[12px] text-[#1E293B] dark:text-[#F8FAFC] leading-relaxed whitespace-pre-wrap max-h-[30vh] overflow-y-auto custom-scrollbar">
                            {msg.insertableClause}
                          </div>
                        </div>
                      )}
                      ...
                      {msg.recommendations && msg.recommendations.length > 0 && (
                        <div className="mt-3 space-y-2">
                          <div className="text-[11px] font-bold uppercase tracking-wider text-[#105B38] mb-1">
                            Alternative Case Law
                          </div>
                          {msg.recommendations.map((edit: any) => (
                            <div
                              key={edit.id}
                              className="w-full p-3 rounded-xl border border-[#105B38]/20 bg-[#105B38]/5"
                            >
                              <button
                                type="button"
                                onClick={() => {
                              ...
                              >
                                ...
                                <p className="text-[11px] text-[#64748B] dark:text-[#94A3B8] leading-normal mt-1">{edit.reason}</p>
                              </button>
                                ...
                                <div className="mt-3 space-y-2 animate-in slide-in-from-top-2">
                                  {edit.originalSnippet && (
                                    <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 p-2.5">
                                      <p className="text-[10px] font-bold text-rose-700 dark:text-rose-300 uppercase tracking-wider mb-1">Before</p>
                                      <p className="text-[11px] text-[#0F172A] dark:text-[#F8FAFC] font-serif">{edit.originalSnippet}</p>
                                    </div>
                                  )}
                                  <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-2.5">
                                    <p className="text-[10px] font-bold text-emerald-700 dark:text-emerald-300 uppercase tracking-wider mb-1">After</p>
                                    <p className="text-[11px] text-[#0F172A] dark:text-[#F8FAFC] font-serif">{edit.suggestedText}</p>
                                  </div>
                                  <div className="flex items-center gap-2 mt-2.5 pt-2.5 border-t border-[#105B38]/10">
                                    <button
                                      type="button"
                                      onClick={() => onInsertClause(edit.suggestedText, edit.title)}
                                      className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-[#105B38] text-white text-xs font-bold shadow-xs transition-colors hover:bg-[#0D4A2E]"
                                    >
                                    ...
                                    <button
                                      ...
                                      className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border border-[#E2E8F0] dark:border-[#1E2D44] bg-white dark:bg-[#131E2E] text-[#64748B] dark:text-[#94A3B8] text-xs font-bold transition-colors hover:bg-[#F8FAFC] dark:hover:bg-[#0B131E]"
                                    >
                                      {copiedId === `rec-${edit.id}` ? <Check className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
