...
export const PublicPreviewShell: React.FC<PublicPreviewShellProps> = ({
  ...
  return (
    <div className="preview-theme-scope min-h-screen flex flex-col bg-[#F8FAFC] text-[#0F172A] antialiased selection:bg-[#105B38]/20 selection:text-[#0F172A]">
      {/* 1. Global Preview Sandbox Banner */}
      
      {/* Optional Top Notification Bar */}
      {bannerNotice && (
        <div className="bg-[#EBF5F0] border-b border-[#A3D4BC] text-[#105B38] px-4 py-2 text-xs text-center font-medium">
          {bannerNotice}
        </div>
      )}
