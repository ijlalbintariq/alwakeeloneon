    ...
    <div className="preview-theme-scope min-h-screen bg-[#F8FAFC] flex items-center justify-center p-3 sm:p-6 relative overflow-hidden text-[#0F172A]">
      ...
      <div className="w-full max-w-lg bg-white border border-[#E2E8F0] shadow-xl shadow-[#105B38]/5 p-6 sm:p-10 rounded-[1.8rem] sm:rounded-[2.2rem] relative z-10">
        ...
        <div className="text-center mb-6 pb-6 border-b border-[#E2E8F0]">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EBF5F0] border border-[#A3D4BC] text-[#105B38] text-[11px] font-semibold mb-2">
            <ShieldCheck className="w-3.5 h-3.5" />
            Pakistan Chambers Legal Portal
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-[#0F172A]" style={{ fontFamily: "'Playfair Display', serif" }}>
            AL WAKEELO
          </h1>
        ...
        {/* Tab Switcher */}
        <div className="grid grid-cols-2 p-1 bg-[#F1F5F9] rounded-xl mb-6 border border-[#E2E8F0]">
          <button
            type="button"
            onClick={() => {
              setMode("login");
            ...
            className={`py-2.5 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${
              mode === "login"
                ? "bg-white text-[#105B38] shadow-sm font-extrabold"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {mode === "register" && (
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#F8FAFC] border border-[#E2E8F0] text-[#0F172A] placeholder-slate-400 pl-10 pr-3 py-3 rounded-xl text-sm focus:outline-none focus:border-[#105B38] focus:ring-2 focus:ring-[#105B38]/20 transition-all"
                  />
                </div>
                <div className="relative">
                  <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#64748B]" />
              ...
              <div className="relative">
                <Award size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#64748B]" />
                <input
                  type="text"
              ...
              <div className="relative">
                <label className="block text-[11px] font-semibold text-[#64748B] mb-1">Primary Jurisdiction / Bench</label>
                <select
                  value={jurisdiction}
                  onChange={(e) => setJurisdiction(e.target.value)}
                  data-testid="select-jurisdiction"
                  className="w-full bg-[#F8FAFC] border border-[#E2E8F0] text-[#0F172A] px-3 py-2.5 rounded-xl text-sm focus:outline-none focus:border-[#105B38] focus:ring-2 focus:ring-[#105B38]/20 transition-all"
                >
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 cursor-pointer text-[#64748B] select-none">
                <input
                  ...
                  className="rounded border-[#E2E8F0] text-[#105B38] focus:ring-[#105B38] accent-[#105B38] h-3.5 w-3.5"
                />
                Remember me
              </label>
              <Link
          ...
          {mode === "register" && (
            <label className="flex items-start gap-2.5 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-3 text-xs text-[#334155] leading-relaxed">
              <input
                type="checkbox"
        ...
        {mode === "login" && verificationHintEmail && (
          <div className="mt-4 p-3 rounded-xl border border-[#A3D4BC] bg-[#EBF5F0] text-xs">
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-[10px] text-[#64748B] uppercase tracking-widest font-bold">or continue with</span>
          <div className="flex-1 h-px bg-[#E2E8F0]" />
        </div>

        {/* Google Sign In Button */}
        {googleLoading ? (
          <div className="w-full bg-[#F8FAFC] border border-[#E2E8F0] text-[#0F172A] font-semibold text-xs py-3 rounded-xl flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="w-full bg-[#F8FAFC] border border-[#E2E8F0] text-[#94A3B8] font-semibold text-xs py-3 rounded-xl flex items-center justify-center gap-2 cursor-not-allowed"
          >
            <SiGoogle size={14} />
          ...
          <button
            ...
            className="w-full bg-white text-[#0F172A] hover:bg-[#F8FAFC] font-semibold text-xs py-3 rounded-xl flex items-center justify-center gap-2.5 transition-all border border-[#E2E8F0] shadow-sm"
          >
        ...
        <div className="mt-4 pt-3 border-t border-[#F1F5F9] flex items-center justify-center gap-2 text-[10px] text-[#64748B]">
