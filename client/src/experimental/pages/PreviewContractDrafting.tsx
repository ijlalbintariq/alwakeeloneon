...
export const PreviewContractDrafting: React.FC = () => {
  ...
  return (
    <PreviewShell>
      <div className="preview-theme-scope min-h-screen bg-[#F8FAFC] pb-16">
        {/* ─── Top Header & Studio Navigation ──────────────────────────────── */}
        <div className="border-b border-[#E2E8F0] bg-white sticky top-0 z-20 shadow-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#EBF5F0] border border-[#A3D4BC] flex items-center justify-center text-[#105B38] shadow-xs">
                <FileText className="w-5 h-5" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="text-lg font-bold text-[#0F172A] font-serif">
                    Commercial Contract Drafting Studio
                  </h1>
                  <Badge className="bg-[#EBF5F0] text-[#105B38] border border-[#A3D4BC] text-[11px] font-mono">
                    Pakistani Law Compliant
                  </Badge>
                </div>
                <p className="text-xs text-[#64748B]">
                  Active: <span className="font-medium text-[#0F172A]">{selectedTemplate?.title}</span> • {selectedTemplate?.governingLaw}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="flex items-center gap-1.5 text-xs text-[#64748B] px-2.5 py-1 bg-slate-50 rounded-lg border border-[#E2E8F0] h-8">
                {saveStatus === "saved" ? (
                  <>
              ...
              <Button
                ...
                className="border-[#A3D4BC] text-[#105B38] hover:bg-[#EBF5F0] gap-1.5 h-8 text-xs font-medium"
              >
              ...
              <Button
                ...
                className="border-[#E2E8F0] text-[#0F172A] hover:bg-slate-50 gap-1.5 h-8 text-xs font-medium"
              >
              ...
              <Button
                ...
                className="border-[#E2E8F0] text-[#0F172A] hover:bg-[#F8FAFC] gap-1.5 h-8 text-xs font-medium"
              >
              ...
              <Button
                ...
                disabled={isScanning}
                className="border-amber-300 text-amber-900 bg-amber-50 hover:bg-amber-100 gap-1.5 h-8 text-xs font-medium"
              >
              ...
              <Button
                ...
                className="border-[#E2E8F0] hover:bg-slate-50 gap-1.5 h-8 text-xs font-medium"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between border-t border-[#F1F5F9] bg-[#FAFCFB]">
            ...
            {/* Document Metrics */}
            <div className="hidden md:flex items-center gap-3 text-[11px] text-[#64748B] font-mono">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          ...
          {activeTab === "editor" && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              {/* Left Canvas (Editor) */}
              <div className={cn("lg:col-span-8 space-y-4", isFullscreen && "fixed inset-0 z-50 bg-white p-6 overflow-y-auto")}>
                <Card className="border-[#E2E8F0] shadow-xs overflow-hidden">
                  <CardHeader className="bg-slate-50/80 border-b border-[#E2E8F0] py-2.5 px-4 flex flex-row items-center justify-between">
                    <div className="flex items-center gap-2 flex-1 mr-4">
                      <Input
                        value={documentTitle}
                        onChange={(e) => setDocumentTitle(e.target.value)}
                        className="font-serif font-bold text-sm bg-transparent border-transparent hover:border-[#E2E8F0] focus:bg-white h-8"
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-[11px] font-mono text-[#64748B] px-1">{fontSize}px</span>
                      <Button
                        variant="ghost"
                        size="icon"
                  ...
                  <CardContent className="p-0">
                    <Textarea
                      ...
                      className="w-full font-serif leading-relaxed p-6 border-0 rounded-none focus-visible:ring-0 focus-visible:ring-offset-0 bg-[#FFFFFF] resize-y"
                      placeholder="Type or paste your legal contract text here..."
                    />
                  </CardContent>
                  <div className="bg-slate-50 border-t border-[#E2E8F0] px-4 py-2 flex items-center justify-between text-xs text-[#64748B]">
              ...
              <div className="lg:col-span-4 space-y-4">
                ...
                <Card className="border-[#E2E8F0] shadow-xs">
                  <CardHeader className="py-3 px-4 bg-slate-50 border-b border-[#E2E8F0]">
                  ...
                  <CardContent className="p-3.5 space-y-2.5">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => setActiveTab("risks")}
                      className="w-full text-xs border-[#A3D4BC] text-[#105B38] hover:bg-[#EBF5F0]"
                    >
                ...
                <Card className="border-[#E2E8F0] shadow-xs">
                  ...
                  <CardContent className="p-3 space-y-2 max-h-[380px] overflow-y-auto">
                    {clauseLibrary.slice(0, 6).map((clause) => (
                      <div
                        key={clause.id}
                        className="p-2.5 rounded-md border border-[#E2E8F0] bg-white hover:border-[#A3D4BC] hover:bg-[#FAFCFB] transition-colors flex items-center justify-between gap-2"
                      >
                        <div className="overflow-hidden">
                          <div className="text-xs font-semibold text-[#0F172A] truncate">{clause.title}</div>
                          <div className="text-[11px] text-[#64748B] truncate">{clause.statutoryReference}</div>
                        </div>
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => handleInsertClause(clause)}
                          className="h-7 px-2 text-[11px] font-medium text-[#105B38] hover:bg-[#EBF5F0] shrink-0"
                        >
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => setActiveTab("clauses")}
                      className="w-full text-xs text-[#105B38] hover:bg-[#EBF5F0] pt-2"
                    >
          ...
          {activeTab === "variables" && (
            <Card className="border-[#E2E8F0] shadow-xs">
              <CardHeader className="bg-slate-50 border-b border-[#E2E8F0]">
                <CardTitle className="text-base font-serif font-bold text-[#0F172A] flex items-center gap-2">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="text-xs font-bold text-[#0F172A] block mb-1">Contract Title / Deed Type</label>
                    <Input
                  ...
                  <div>
                    <label className="text-xs font-bold text-[#0F172A] block mb-1">Consideration / Value (PKR)</label>
                    <Input
                  ...
                  <div>
                    <label className="text-xs font-bold text-[#0F172A] block mb-1">Jurisdiction / Seat City</label>
                    <Select
                ...
                <div className="p-4 rounded-lg bg-slate-50 border border-[#E2E8F0] space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                      <label className="text-[11px] font-medium text-[#64748B] block mb-1">Full Legal Name</label>
                      <Input
                    ...
                    <div>
                      <label className="text-[11px] font-medium text-[#64748B] block mb-1">CNIC / CUIN No.</label>
                      <Input
                    ...
                    <div>
                      <label className="text-[11px] font-medium text-[#64748B] block mb-1">Registered Address</label>
                      <Input
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="md:col-span-2">
                    <label className="text-xs font-bold text-[#0F172A] block mb-1">Subject Property / Scope of Work</label>
                    <Input
                  ...
                  <div>
                    <label className="text-xs font-bold text-[#0F172A] block mb-1">Effective Date</label>
                    <Input
                      type="date"
                  ...
                  <div>
                    <label className="text-xs font-bold text-[#0F172A] block mb-1">Notice Period (Days)</label>
                    <Input
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredClauses.map((clause) => (
                  <Card key={clause.id} className="border-[#E2E8F0] shadow-xs flex flex-col justify-between">
                    <CardHeader className="py-3 px-4 bg-slate-50/80 border-b border-[#E2E8F0]">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <Badge className="bg-[#EBF5F0] text-[#105B38] border border-[#A3D4BC] text-[10px] mb-1">
                            {clause.category}
                          </Badge>
                          <CardTitle className="text-sm font-bold text-[#0F172A]">{clause.title}</CardTitle>
                          <p className="text-[11px] text-[#64748B]">{clause.statutoryReference}</p>
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent className="p-4 flex-1">
                      <p className="text-xs text-[#475569] mb-3">{clause.subtitle}</p>
                      <div className="p-2.5 rounded bg-slate-50 border border-[#E2E8F0] text-[11px] font-serif text-[#334155] max-h-36 overflow-y-auto leading-relaxed whitespace-pre-wrap">
                        {clause.clauseText}
                      </div>
                    </CardContent>
            ...
            <div className="space-y-6">
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-center p-4 rounded-xl bg-slate-50 border border-[#E2E8F0] min-w-[140px]">
                        <div className="text-3xl font-extrabold text-[#105B38] font-mono">{riskAnalysis.score}%</div>
                        <div className="text-xs font-semibold text-[#64748B] mt-0.5">{riskAnalysis.grade}</div>
                      </div>
                      <Button
                        onClick={handleTriggerScan}
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-[#0F172A] flex items-center gap-2">
                  <AlertTriangle className="w-4 h-4 text-amber-600" /> Detected Vulnerabilities & Legal Redlines (
                ...
                {riskAnalysis.findings.length === 0 ? (
                  <Card className="border-emerald-200 bg-emerald-50/40 p-8 text-center">
                    ...
                    <h4 className="text-sm font-bold text-emerald-900">Zero Critical Vulnerabilities Detected</h4>
                  ...
                  riskAnalysis.findings.map((finding) => (
                    <Card
                      ...
                      className={cn(
                        "border shadow-xs",
                        finding.category === "danger" ? "border-rose-300 bg-white" : "border-amber-300 bg-white"
                      )}
                    >
                      <CardHeader className="py-3 px-4 bg-slate-50 border-b border-[#E2E8F0]">
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            <CardTitle className="text-sm font-bold text-[#0F172A]">{finding.title}</CardTitle>
                          </div>
                          <span className="text-[11px] font-mono text-[#64748B]">{finding.statutoryReference}</span>
                        </div>
                      </CardHeader>
                      <CardContent className="p-4 space-y-3">
                        <p className="text-xs text-[#334155] leading-relaxed">{finding.ruleDescription}</p>

                        <div className="p-3 rounded bg-amber-50/60 border border-amber-200 text-xs text-amber-900 flex items-start gap-2">
                        ...
                        <div className="pt-2 flex items-center justify-end gap-2">
                          {acceptedRedlines[finding.id] ? (
                            <Badge className="bg-emerald-100 text-emerald-800 border-emerald-300 text-xs gap-1 py-1 px-2.5">
        ...
        <Dialog open={isTemplateModalOpen} onOpenChange={setIsTemplateModalOpen}>
          <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-lg font-serif font-bold text-[#0F172A] flex items-center gap-2">
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      selectedTemplate?.id === template.id
                        ? "border-[#105B38] bg-[#EBF5F0]/60 ring-1 ring-[#105B38]"
                        : "border-[#E2E8F0] bg-white hover:border-[#A3D4BC] hover:bg-[#FAFCFB]"
                    )}
                  >
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      <Badge className="bg-white text-[#105B38] border border-[#A3D4BC] text-[10px]">
                        {template.category}
                      </Badge>
                      <span className="text-[10px] font-mono text-[#64748B]">{template.forum}</span>
                    </div>
                    <div className="font-bold text-xs text-[#0F172A] mb-1">{template.title}</div>
        ...
        <Dialog open={isExportModalOpen} onOpenChange={setIsExportModalOpen}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle className="text-base font-serif font-bold text-[#0F172A] flex items-center gap-2">
            ...
            <div className="space-y-3 pt-2">
              <Button
                ...
                className="w-full justify-start bg-white hover:bg-slate-50 text-[#0F172A] border border-[#E2E8F0] h-14 p-4 shadow-xs"
              >
                <div className="w-8 h-8 rounded bg-blue-50 text-blue-700 flex items-center justify-center mr-3 shrink-0 font-bold text-xs">
                  DOCX
                </div>
                <div className="text-left">
                  <div className="text-xs font-bold">Microsoft Word Document (.docx)</div>
                  <div className="text-[11px] text-[#64748B]">Editable document with 1.5&quot; court margin and signature blocks</div>
                </div>
              </Button>
              ...
              <Button
                ...
                className="w-full justify-start bg-white hover:bg-slate-50 text-[#0F172A] border border-[#E2E8F0] h-14 p-4 shadow-xs"
              >
                <div className="w-8 h-8 rounded bg-rose-50 text-rose-700 flex items-center justify-center mr-3 shrink-0 font-bold text-xs">
                  PDF
                </div>
                <div className="text-left">
                  <div className="text-xs font-bold">Court-Ready PDF Document (.pdf)</div>
                  <div className="text-[11px] text-[#64748B]">Printable legal brief with chambers watermark and stamp space</div>
                </div>
              </Button>
              ...
              <Button
                ...
                className="w-full justify-start bg-white hover:bg-slate-50 text-[#0F172A] border border-[#E2E8F0] h-14 p-4 shadow-xs"
              >
                <div className="w-8 h-8 rounded bg-emerald-50 text-emerald-700 flex items-center justify-center mr-3 shrink-0 font-bold text-xs">
                  TXT
                </div>
                <div className="text-left">
                  <div className="text-xs font-bold">Plain Text / Markdown (.txt)</div>
                  <div className="text-[11px] text-[#64748B]">Raw unformatted text for archiving or email dispatch</div>
                </div>
              </Button>
            </div>
          </DialogContent>
