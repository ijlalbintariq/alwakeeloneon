    ...
    <PublicPreviewShell>
      <div className="space-y-10 md:space-y-12">
        ...
        <section className="space-y-4 max-w-4xl mx-auto text-center pt-2">
          ...
          <div className="mt-6 p-4 sm:p-5 bg-white border border-[#A3D4BC] rounded-2xl text-left shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <span className="px-3 py-1 bg-[#EBF5F0] text-[#105B38] text-[11px] font-bold rounded-full border border-[#A3D4BC] whitespace-nowrap">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 bg-white border border-[#E2E8F0] rounded-3xl p-6 sm:p-10 space-y-10 shadow-sm leading-relaxed text-xs sm:text-sm text-[#334155]">
            ...
            <section id="sec-1" className="space-y-3 scroll-mt-28">
              ...
              <p>
                This Privacy Policy explains how <strong className="text-[#0F172A]">Alwakeelo</strong> ("Platform", "Service", "we", "us", or "our"), operated by <strong className="text-[#0F172A]">Majnoon Studio (Pvt.) Ltd.</strong> (registered business name in Pakistan), collects, processes, secures, and protects information when advocates, legal chambers, organizations, and individuals utilize our legal technology workstation and associated services.
              </p>
              <p>
            ...
            <section id="sec-2" className="space-y-3 scroll-mt-28">
              ...
              <ul className="list-disc list-inside space-y-1.5 pl-2 text-[#334155]">
                <li>
                  <strong className="text-[#0F172A]">Article 9 of the Qanun-e-Shahadat Order, 1984:</strong> Legal professional communications and attorney-client confidentiality protections.
                </li>
                <li>
                  <strong className="text-[#0F172A]">Pakistan Legal Practitioners and Bar Councils Rules:</strong> Ethical standards mandating advocate vigilance over client confidences.
                </li>
                <li>
                  <strong className="text-[#0F172A]">Prevention of Electronic Crimes Act (PECA 2016):</strong> Statutory protections safeguarding unauthorized access to electronic data.
                </li>
              </ul>
            </section>
            ...
            <section id="sec-3" className="space-y-3 scroll-mt-28">
              ...
              <div className="space-y-2.5 pt-1">
                <div className="p-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl space-y-1">
                  <p className="font-bold text-[#0F172A]">A. Account &amp; Bar Profile Data</p>
                  <p className="text-xs text-[#64748B]">
                ...
                <div className="p-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl space-y-1">
                  <p className="font-bold text-[#0F172A]">B. Research Queries &amp; Pleading Content</p>
                  <p className="text-xs text-[#64748B]">
                ...
                <div className="p-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl space-y-1">
                  <p className="font-bold text-[#0F172A]">C. Billing &amp; Provincial Tax Details</p>
                  <p className="text-xs text-[#64748B]">
            ...
            <section id="sec-6" className="space-y-3 scroll-mt-28">
              ...
              <ul className="list-disc list-inside space-y-1.5 pl-2 text-[#334155]">
                <li><strong className="text-[#0F172A]">Data in Transit:</strong> 256-bit TLS 1.3 encryption across all web, mobile, and Word Add-in API traffic.</li>
                <li><strong className="text-[#0F172A]">Data at Rest:</strong> AES-256 encryption on all persistent database storage partitions.</li>
                <li><strong className="text-[#0F172A]">Password Security:</strong> One-way cryptographic hashing using salted bcrypt algorithms.</li>
                <li><strong className="text-[#0F172A]">Access Control:</strong> Strict role-based access control (RBAC) preventing unauthorized cross-chamber data access.</li>
              </ul>
            </section>
            ...
            <section id="sec-8" className="space-y-3 scroll-mt-28">
              ...
              <ul className="list-disc list-inside space-y-1.5 pl-2 text-[#334155]">
                <li><strong className="text-[#0F172A]">Secure Cloud Infrastructure:</strong> High-availability serverless PostgreSQL database providers.</li>
                <li><strong className="text-[#0F172A]">Payment Gateways:</strong> Safepay, Kuickpay, and 1Bill for automated invoice and subscription settlement.</li>
                <li><strong className="text-[#0F172A]">Legal Compulsion:</strong> Only when strictly required by a competent court of record in Pakistan under lawful process.</li>
              </ul>
            </section>
            ...
            <section id="sec-14" className="space-y-3 scroll-mt-28">
              ...
              <div className="p-4 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl text-xs space-y-1.5">
                <p><strong className="text-[#0F172A]">Data Protection Officer:</strong> Legal Compliance Cell</p>
                <p><strong className="text-[#0F172A]">Parent Entity:</strong> Majnoon Studio (Pvt.) Ltd.</p>
                <p><strong className="text-[#0F172A]">Direct Compliance Email:</strong> <a href="mailto:support@alwakeelo.com" className="text-[#105B38] font-mono font-semibold underline">support@alwakeelo.com</a></p>
                <p><strong className="text-[#0F172A]">Chamber Helpline:</strong> <a href="tel:00923358341897" className="text-[#105B38] font-mono font-semibold">+92 335 834 1897</a></p>
              </div>
            </section>
          </div>
        </section>
