    ...
    <PublicPreviewShell>
      <div className="space-y-10 md:space-y-12">
        ...
        <section className="space-y-4 max-w-4xl mx-auto text-center pt-2">
          ...
          <div className="mt-6 p-4 sm:p-5 bg-white dark:bg-[#131E2E] border border-[#A3D4BC] dark:border-[#10B981]/30 rounded-2xl shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-left">
        ...
        <div className="flex justify-center border-b border-[#E2E8F0] dark:border-[#1E2D44]">
            ...
            <button
              ...
              className={`px-5 py-3 text-xs font-bold uppercase tracking-wider border-b-2 transition-all ${
                activeTab === "policy"
                  ...
                  : "border-transparent text-[#64748B] dark:text-[#94A3B8] dark:text-[#475569] hover:text-[#0F172A] dark:text-[#F8FAFC]"
              }`}
            >
        ...
        {/* ── TAB 1: POLICY TERMS ── */}
        {activeTab === "policy" && (
          <div className="bg-white dark:bg-[#131E2E] border border-[#E2E8F0] dark:border-[#1E2D44] rounded-3xl p-6 sm:p-10 space-y-8 shadow-sm leading-relaxed text-xs sm:text-sm text-[#334155] dark:text-[#CBD5E1] max-w-4xl mx-auto">
            {/* Section 1 */}
            <section className="space-y-3">
              <h2
                className="text-lg font-bold text-[#0F172A] dark:text-[#F8FAFC] border-b border-[#F1F5F9] pb-2"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                1. Scope of Policy
              </h2>
              <p>
                This Cancellation, Return, and Refund Policy applies to all paid subscriptions, token top-ups, and enterprise chamber licenses purchased on the <strong className="text-[#0F172A] dark:text-[#F8FAFC]">Alwakeelo</strong> legal intelligence platform, operated by <strong className="text-[#0F172A] dark:text-[#F8FAFC]">Majnoon Studio (Pvt.) Ltd.</strong>
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc list-inside space-y-1.5 pl-2 text-[#334155] dark:text-[#CBD5E1]">
                <li><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Duplicate Charge:</strong> Verified billing errors resulting in double-charging on your credit card, Kuickpay, or bank transfer.</li>
                <li><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Unscheduled Platform Outage:</strong> Continuous platform unavailability exceeding forty-eight (48) consecutive hours caused by our server infrastructure.</li>
                <li><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Unauthorized Fraudulent Charge:</strong> Charge made after reporting stolen account credentials or unauthorized credit card usage.</li>
              </ul>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                Once approved, refunds are initiated within <strong className="text-[#0F172A] dark:text-[#F8FAFC]">7 to 14 business days</strong>. Depending on your financial institution:
              </p>
              <ul className="list-disc list-inside space-y-1.5 pl-2 text-[#334155] dark:text-[#CBD5E1]">
                <li><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Safepay Credit/Debit Cards:</strong> Reversal appears on your card statement within 5–10 banking days.</li>
                <li><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Kuickpay / 1Bill / Bank Wire:</strong> Transferred directly to your provided IBAN within 7 banking days.</li>
                <li><strong className="text-[#0F172A] dark:text-[#F8FAFC]">JazzCash / EasyPaisa:</strong> Credited to your registered mobile wallet within 3–5 banking days.</li>
              </ul>
            </section>
            ...
            <section className="space-y-3">
              ...
              <div className="p-4 bg-[#F8FAFC] dark:bg-[#0B131E] border border-[#E2E8F0] dark:border-[#1E2D44] rounded-2xl text-xs space-y-1.5">
                <p><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Billing Desk:</strong> Majnoon Studio (Pvt.) Ltd.</p>
                <p><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Email:</strong> <a href="mailto:support@alwakeelo.com" className="text-[#105B38] font-mono underline">support@alwakeelo.com</a></p>
                <p><strong className="text-[#0F172A] dark:text-[#F8FAFC]">Chambers Hotline:</strong> <a href="tel:00923358341897" className="text-[#105B38] font-mono">+92 335 834 1897</a></p>
              </div>
            </section>
          </div>
        )}
        ...
        {activeTab === "request" && (
          <div className="max-w-2xl mx-auto">
            {submitted ? (
              <div className="bg-white dark:bg-[#131E2E] border border-[#A3D4BC] dark:border-[#10B981]/30 rounded-3xl p-8 sm:p-12 text-center space-y-6 shadow-sm flex flex-col items-center justify-center">
                <div className="w-16 h-16 rounded-2xl bg-[#EBF5F0] dark:bg-[#105B38]/20 border border-[#A3D4BC] dark:border-[#10B981]/30 flex items-center justify-center text-[#105B38] animate-bounce">
                  <CheckCircle2 className="w-8 h-8" />
                </div>
                <div className="space-y-2">
                  <h3
                    className="text-2xl font-bold text-[#0F172A] dark:text-[#F8FAFC]"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                  ...
                  <div className="inline-block px-4 py-1.5 bg-[#F1F5F9] dark:bg-[#1E2D44] border border-[#E2E8F0] dark:border-[#1E2D44] rounded-lg font-mono font-bold text-sm text-[#105B38]">
                    {refundRef}
                  </div>
                  <p className="text-xs text-[#334155] dark:text-[#CBD5E1] leading-relaxed pt-2">
                    Our billing team has received your refund request for invoice <strong className="text-[#0F172A] dark:text-[#F8FAFC]">{form.transactionRef}</strong>. We will review your account activity and process your refund within 7–14 business days to your original payment method.
                  </p>
                </div>
                <button
                  onClick={() => {
              ...
              <form
                ...
                className="bg-white dark:bg-[#131E2E] border border-[#E2E8F0] dark:border-[#1E2D44] rounded-3xl p-6 sm:p-8 space-y-5 shadow-sm"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-[#334155] dark:text-[#CBD5E1] uppercase tracking-wider">
                      Account Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-3.5 py-2.5 bg-[#F8FAFC] dark:bg-[#0B131E] border border-[#CBD5E1] rounded-xl text-xs text-[#0F172A] dark:text-[#F8FAFC] focus:outline-none focus:border-[#105B38]"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-[#F8FAFC] dark:bg-[#0B131E] border border-[#CBD5E1] rounded-xl text-xs text-[#0F172A] dark:text-[#F8FAFC] focus:outline-none focus:border-[#105B38] font-mono"
                    />
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 bg-[#F8FAFC] dark:bg-[#0B131E] border border-[#CBD5E1] rounded-xl text-xs text-[#0F172A] dark:text-[#F8FAFC] focus:outline-none focus:border-[#105B38] resize-none"
                  />
                </div>
