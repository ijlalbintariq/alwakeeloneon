...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    features: [
      ...
      "Uploads: 30 files/month",
      "PDF upload in chat: up to 250 pages/month",
    ],
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      "Output caps: Standard 8,192 · Turbo 8,192",
      "Uploads: 100 files/month",
      "PDF upload in chat: up to 500 pages/month",
    ],
    highlighted: true,
  },
  {
    ...
    features: [
      ...
      "Output caps: Standard 8,192 · Turbo 8,192 · Apex 8,192",
      "Apex monthly cap: 180 requests",
      "Uploads: 300 files/month",
      "PDF upload in chat: up to 1,500 pages/month",
    ],
    highlighted: false,
  },
  {
