      ...
      <section id="features" className="py-20 md:py-28 px-6 bg-[#0f172a]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard icon={FileText} title="Legal Drafting" desc="Draft professional legal documents, petitions, applications, and notices with AI assistance." bgClass="bg-purple-500/10" iconClass="text-purple-500" />
