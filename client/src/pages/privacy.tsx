    ...
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">2. Information We Collect</h2>
            <h3 className="text-lg font-semibold text-white mb-2">2.1 Personal Information</h3>
            <p className="text-slate-300 leading-relaxed mb-3">When you create an account, we may collect:</p>
            ...
            <h3 className="text-lg font-semibold text-white mb-2 mt-4">2.2 Usage Data</h3>
            <p className="text-slate-300 leading-relaxed mb-3">We automatically collect certain information when you use the Service:</p>
            <ul className="list-disc list-inside text-slate-300 space-y-1 ml-4">
            ...
            <h3 className="text-lg font-semibold text-white mb-2 mt-4">2.3 Technical Data</h3>
            <ul className="list-disc list-inside text-slate-300 space-y-1 ml-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">3. How We Use Your Information</h2>
            <p className="text-slate-300 leading-relaxed mb-3">We use the collected information for:</p>
            <ul className="list-disc list-inside text-slate-300 space-y-1 ml-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">4. Data Sharing and Disclosure</h2>
            <p className="text-slate-300 leading-relaxed mb-3">We may share your information with:</p>
            <ul className="list-disc list-inside text-slate-300 space-y-1 ml-4">
              <li><strong className="text-white">AI Service Providers:</strong> Your queries and uploaded documents are processed through third-party AI services. Please review their respective privacy policies for details on data handling.</li>
              <li><strong className="text-white">Authentication Providers:</strong> If you use Google OAuth, certain profile information is exchanged with Google.</li>
              <li><strong className="text-white">Legal Requirements:</strong> We may disclose information if required by Pakistani law, court order, or government request.</li>
            </ul>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">5. Data Security</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">6. Data Retention</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">8. Cookies and Session Data</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">9. Third-Party Services</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">10. Children's Privacy</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">11. Changes to This Policy</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">12. Contact Us</h2>
            <p className="text-slate-300 leading-relaxed">
      ...
      <footer className="py-8 px-6 border-t border-slate-800/50">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <a href="/terms" onClick={(e) => { e.preventDefault(); navigate("/terms"); }} className="text-xs text-slate-500 hover:text-slate-300 transition-colors">Terms of Service</a>
          </div>
        </div>
      </footer>
    </div>
