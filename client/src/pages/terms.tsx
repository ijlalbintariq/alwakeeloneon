    ...
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-6 py-10 md:py-16">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">2. Description of Service</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">3. Important Legal Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">4. User Accounts</h2>
            <p className="text-slate-300 leading-relaxed mb-3">To use the Service, you must:</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">6. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">7. Intellectual Property</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">8. Uploaded Content and Documents</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">9. Conversation Sharing</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">10. Limitation of Liability</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">11. Indemnification</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">12. Governing Law</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">13. Termination</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-500 mb-3">14. Modifications to Terms</h2>
            <p className="text-slate-300 leading-relaxed">
