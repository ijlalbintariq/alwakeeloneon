...
export const TIER_LIMITS: Record<string, TierPlanConfig> = {
  free: {
    ...
    maxOutputTokens: { standard: 3200, turbo: 0, apex: 0 },
    apexMonthlyCap: 0,
  ...
  pro: {
    ...
    maxOutputTokens: { standard: 3200, turbo: 6000, apex: 0 },
    apexMonthlyCap: 0,
  ...
  chamber: {
    ...
    maxOutputTokens: { standard: 3200, turbo: 6000, apex: 6000 },
    apexMonthlyCap: 180,
  ...
  enterprise: {
    ...
    pooled: true,
    modeAccess: { standard: true, turbo: true, apex: true },
    maxOutputTokens: { standard: 3200, turbo: 8192, apex: 8192 },
    apexMonthlyCap: 4500,
